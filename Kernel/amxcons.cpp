...
#define amx_printf    CONSOLE_PRINTF
#define amx_putchar   CONSOLE_PUTCHAR
#define amx_fflush    __noop
#define amx_getch     CONSOLE_GETCHAR
#define amx_gets(s,n) CONSOLE_GETS(s,n)
