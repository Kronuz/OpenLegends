...
strcmp(const string1[], const string2[]); /*!< 
	...
	\remarks Note that this comparison is case sensitive.

	<b>Example:</b>
	\code
	...
	new comp;
	comp = strcmp("Apple", "apple");
	// now comp value is < 0; because 'A' < 'a'          
	...
	\endcode
...
*/
#endif
static cell AMX_NATIVE_CALL core_stricmp(AMX *amx,cell *params)
{
  char szString1[1024];
  char szString2[1024];
  cell *n1;
