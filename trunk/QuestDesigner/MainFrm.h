...
public:
	...
	BEGIN_UPDATE_UI_MAP(CMainFrame)
		...
		UPDATE_ELEMENT(ID_SCRIPTED_SAVE, UPDUI_MENUPOPUP | UPDUI_TOOLBAR )
		UPDATE_ELEMENT(ID_SCRIPTED_SAVE_ALL, UPDUI_MENUPOPUP | UPDUI_TOOLBAR )
		UPDATE_ELEMENT(ID_SCRIPTED_SAVE_AS, UPDUI_MENUPOPUP )
		UPDATE_ELEMENT(ID_SCRIPTED_PRINT, UPDUI_MENUPOPUP | UPDUI_TOOLBAR )
		UPDATE_ELEMENT(ID_SCRIPTED_PRINT_SETUP, UPDUI_MENUPOPUP )

		UPDATE_ELEMENT(ID_SCRIPTED_UNDO, UPDUI_MENUPOPUP | UPDUI_TOOLBAR )
		UPDATE_ELEMENT(ID_SCRIPTED_REDO, UPDUI_MENUPOPUP | UPDUI_TOOLBAR )
		UPDATE_ELEMENT(ID_SCRIPTED_CUT, UPDUI_MENUPOPUP | UPDUI_TOOLBAR )
		UPDATE_ELEMENT(ID_SCRIPTED_COPY, UPDUI_MENUPOPUP | UPDUI_TOOLBAR )
		UPDATE_ELEMENT(ID_SCRIPTED_PASTE, UPDUI_MENUPOPUP | UPDUI_TOOLBAR )
		UPDATE_ELEMENT(ID_SCRIPTED_ERASE, UPDUI_MENUPOPUP | UPDUI_TOOLBAR )		
	...
	BEGIN_MSG_MAP(CMainFrame)
		...
		COMMAND_ID_HANDLER(ID_SCRIPTED_NEW, OnFileNew)
		COMMAND_ID_HANDLER(ID_SCRIPTED_OPEN, OnFileOpen)
		...
		SIMPLE_MESSAGE_HANDLER(WMQD_DELTREE, m_FoldersView.DelTree)
