...
public:
	...
	BEGIN_UPDATE_UI_MAP(CMainFrame)
		...
		UPDATE_ELEMENT(ID_SCRIPTED_NEW, UPDUI_MENUPOPUP | UPDUI_TOOLBAR)
		UPDATE_ELEMENT(ID_SCRIPTED_OPEN, UPDUI_MENUPOPUP | UPDUI_TOOLBAR)
	...
	BEGIN_MSG_MAP(CMainFrame)
		...
		COMMAND_ID_HANDLER(ID_SCRIPTED_NEW, OnScriptFileNew)
		COMMAND_ID_HANDLER(ID_SCRIPTED_OPEN, OnScriptFileOpen)
