...
class ASResource
{
    public:
        ...
        static const string AS_CLASS, AS_STRUCT, AS_UNION, AS_INTERFACE, AS_NAMESPACE, AS_EXTERN, AS_NEW; // AS_NEW added by Kronuz
...
class ASFormatter : public ASBeautifier
{
    ...
    private:
        ...
        static vector<const string*> preVariableHeaders;
