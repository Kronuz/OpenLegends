...
//  and "TabbedFrame.h"
//
// Modified by Kronuz. July 25, 2003.
//////////////////////////////////////////////////////////////////////
...
#ifndef DF_OLD_TABBED_WINDOWS
class CTabbedDockingWindow :
	public dockwins::CBoxedDockingWindowImpl< CTabbedDockingWindow, CWindow, dockwins::COutlookLikeBoxedDockingWindowTraits>
{
protected:
	typedef CTabbedDockingWindow thisClass;
	typedef dockwins::CBoxedDockingWindowImpl< CTabbedDockingWindow, CWindow, dockwins::COutlookLikeBoxedDockingWindowTraits> baseClass;
...
// Constructors
public:
	CTabbedDockingWindow(HWND hWndClient = NULL) : 
...
public:
	static CTabbedDockingWindow* CreateInstance(void)
	{
		return new CTabbedDockingWindow;
	}
