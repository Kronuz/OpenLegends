...
public:
	...
	BEGIN_MSG_MAP(CScriptEditorView)
		...
		COMMAND_ID_HANDLER(ID_EDIT_TAB, OnEditTab)
		COMMAND_ID_HANDLER(ID_EDIT_UNTAB, OnEditUntab)
		
		COMMAND_ID_HANDLER(ID_EDIT_FIND_NEXT, OnEditFindNext)
		COMMAND_ID_HANDLER(ID_EDIT_FIND_PREV, OnEditFindPrev)
		COMMAND_ID_HANDLER(ID_EDIT_FIND_SELECTION, OnEditFindSelection)

		COMMAND_ID_HANDLER(ID_EDIT_GOTO_LINE, OnEditGotoLine)
		COMMAND_ID_HANDLER(ID_EDIT_MATCH_BRACE, OnEditMatchBrace)
		
		COMMAND_ID_HANDLER(ID_EDIT_READ_ONLY, OnEditReadOnly)

		COMMAND_ID_HANDLER(ID_EDIT_UPPERCASE, OnEditUppercase)
		COMMAND_ID_HANDLER(ID_EDIT_LOWERCASE, OnEditLowercase)
		COMMAND_ID_HANDLER(ID_EDIT_TABIFY, OnEditTabify)
		COMMAND_ID_HANDLER(ID_EDIT_UNTABIFY, OnEditUntabify)
		COMMAND_ID_HANDLER(ID_EDIT_SHOW_WHITE_SPACE, OnShowWhiteSpace)
		
		COMMAND_ID_HANDLER(ID_EDIT_TOGGLE_BOOKMARK, OnEditToggleBookmark)
		COMMAND_ID_HANDLER(ID_EDIT_GOTO_NEXT_BOOKMARK, OnEditGotoNextBookmark)
		COMMAND_ID_HANDLER(ID_EDIT_GOTO_PREV_BOOKMARK, OnUpdateEditGotoPrevBookmark)
		COMMAND_ID_HANDLER(ID_EDIT_CLEAR_ALL_BOOKMARKS, OnEditClearAllBookmarks)
